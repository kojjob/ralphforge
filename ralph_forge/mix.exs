defmodule RalphForge.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind ralph_forge", "esbuild ralph_forge"],
      "assets.deploy": [
        "tailwind ralph_forge --minify",
        "esbuild ralph_forge --minify",
        "phx.digest"
      ],
